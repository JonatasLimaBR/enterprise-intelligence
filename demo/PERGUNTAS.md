...
|---|----------|----------------------|--------|
| 1 | O que está errado ou degradando? | Console → lista de incidentes; `eict_ops.incidents` | ✅ respondida |
...
| 4 | Qual é o impacto técnico, operacional, financeiro e regulatório? | Console → ativos afetados (lineage) e custo incremental | ⚠️ parcial: técnico e financeiro sim; regulatório fora do escopo |
...
| 9 | Quais ativos, processos, pessoas e clientes dependem do componente? | Console → ativos afetados via lineage do catálogo | ⚠️ parcial: ativos sim; pessoas e clientes não |
