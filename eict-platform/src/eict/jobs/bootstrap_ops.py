...
TABLES: dict[tuple[str, str], str] = {
    ...
    ("ops", "cost_allocation"): """
        ...
        computed_at TIMESTAMP
    """,
    ("ops", "cost_reconciliation"): """
        period_label STRING NOT NULL,
        period_start TIMESTAMP,
        period_end TIMESTAMP,
        period_status STRING,
        watermark TIMESTAMP,
        total_billing DECIMAL(18,4),
        allocated DECIMAL(18,4),
        platform_pool DECIMAL(18,4),
        unallocated DECIMAL(18,4),
        difference DECIMAL(18,4),
        tolerance DECIMAL(18,4),
        reconciled BOOLEAN,
        reason STRING,
        unpriced_dbus DOUBLE,
        allocated_share DOUBLE,
        currency STRING,
        price_basis STRING,
        scope STRING,
        computed_at TIMESTAMP
    ...
    ("ops", "cost_units"): """
        ...
        computed_at TIMESTAMP
    """,
    # Economia (FinOps B): o ciclo propõe e mede (read models substituídos por inteiro); a decisão
    # humana mora em `savings_initiatives`, que o ciclo nunca escreve.
    ("ops", "savings_opportunities"): """
        ...
        contained_in STRING,
        counted BOOLEAN,
        estimate_usd DECIMAL(18,4),
        estimate_low DECIMAL(18,4),
        estimate_high DECIMAL(18,4),
        n INT,
    ...
    ("ops", "savings_detectors"): """
        ...
        below_threshold INT,
        below_threshold_usd DECIMAL(18,4),
        config_error STRING,
        policy_version STRING,
        computed_at TIMESTAMP
    """,
    ("ops", "savings_initiatives"): """
        ...
        change_ref STRING,
        implementation_cost_usd DECIMAL(18,4),
        self_approved BOOLEAN
    """,
    ("ops", "savings_realization"): """
        initiative_id STRING NOT NULL,
        state STRING,
        unit STRING,
        baseline_median DECIMAL(18,6),
        after_median DECIMAL(18,6),
        n_before INT,
        n_after INT,
        monthly_volume DOUBLE,
        gross_usd DECIMAL(18,4),
        net_usd DECIMAL(18,4),
        side_effect_incidents ARRAY<STRING>,
        reason STRING,
        currency STRING,
        price_basis STRING,
        policy_version STRING,
